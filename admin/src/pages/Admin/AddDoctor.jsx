  ...
  return (
        <form onSubmit={onSubmitHandler} className='m-5 w-full'>
         ...
         <div className='flex-1 flex flex-col gap-1'>
                            ...
                            <textarea onChange={(e)=> setAbout(e.target.value)} value={about} className='w-full px-4 pt-2 border border-[#DADADA] rounded ' type="text" placeholder='write about doctor' rows={5} required/>
        </div>
