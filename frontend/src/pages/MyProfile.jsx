...
const [userData,setUserData] = useState({
  ...
  phone: '+1 234 678 6788',
  address:{
    line1:"Biswo Bangla Road, Chinarpark ",
        ...
        <p className='font-medium'>Address</p>
        {
          ...
          <div>
            ...
            <div className='grid grid-cols-[1fr_3fr] gap-y-2.5 mt-3 text-neutral-700'>
              ...
              {
          isEdit
          ? <select  className ='text-gray-400'onChange={(e)=> setUserData(prev => ({...prev,gender:e.target.value}))} value={userData.gender}>
